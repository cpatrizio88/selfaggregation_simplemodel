...
domsizes = np.linspace(7000, 50000, 20)
#colors = ['k', 'r', 'g']


alphas = np.array([0.05, 0.08, 0.10])
#alphas = np.array([0])
...
for v, alpha in enumerate(alphas):
    ...
    plt.figure(1)
    plt.plot(l_ds/1e3, massbalance, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'mass down - mass up (Pa m$^{2}$ s$^{-1}$)')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day, $Q_{{m,trop}} K/day$ = {:2.3f}'.format(dheatrate, mheatrate))
    if v == end-1:
        plt.legend()
    ...
    plt.figure(2)
    plt.plot(l_ds/1e3, waterbalance, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'E - P (mm/day)')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day, $Q_{{m,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        plt.legend()
    ...
    plt.figure(3)
    plt.plot(l_ds/1e3, Ebalance, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(4)
    plt.plot(l_ds/1e3, l_ms/1e3, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$l_m$ (km)')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day, $Q_{{m,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
    ...
    plt.figure(5)
    plt.plot(l_ds/1e3, (l_ms**2/l_ds**2), 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$\sigma$')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day, $Q_{{m,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
    ...
    plt.figure(6)
    plt.plot(l_ds/1e3, w_ms, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(7)
    plt.plot(l_ds/1e3, RHs, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.ylim(0,1)
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'RH$_m$')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day, $Q_{{m,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    ...
    plt.figure(8)
    plt.plot(l_ds/1e3, Ps, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(9)
    plt.plot(l_ds/1e3, -delhs, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(10)
    plt.plot(l_ds/1e3, p_LCLs/1e2, 'o-', label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
