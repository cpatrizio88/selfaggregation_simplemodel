...
domsizes = np.linspace(15000,20e3, 20)
#colors = ['k', 'r', 'g']



mheatrates = np.array([-0.6])
end = len(mheatrates)
...
for v, mheatrate in enumerate(mheatrates):
    ...
    for j, domsize in enumerate(domsizes):
        ...
        dheatrate=-1.5 #prescribed heating rate in moist region interior K/day
    ...
    plt.figure(1)
    plt.plot(l_ds/1e3, massbalance, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    ...
    plt.figure(2)
    plt.plot(l_ds/1e3, waterbalance, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.xlabel(r'l$_d$ (km)')
    ...
    plt.figure(3)
    plt.plot(l_ds/1e3, Ebalance, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.xlabel(r'l$_d$ (km)')
    ...
    plt.figure(4)
    plt.plot(l_ds/1e3, l_ms/1e3, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.xlabel(r'l$_d$ (km)')
    ...
    plt.figure(5)
    plt.plot(l_ds/1e3, (l_ms**2)/(l_ds**2), 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.xlabel(r'l$_d$ (km)')
    plt.ylabel(r'$\sigma$')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day'.format(dheatrate))
    if v == end-1:
    ...
    plt.figure(6)
    plt.plot(l_ds/1e3, w_ms, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.xlabel(r'l$_d$ (km)')
    ...
    plt.figure(7)
    plt.plot(l_ds/1e3, RHs, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.ylim(0,1)
    plt.xlabel(r'l$_d$ (km)')
    plt.ylabel(r'RH$_m$')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day'.format(dheatrate))
    ...
    plt.figure(8)
    plt.plot(l_ds/1e3, Ps, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.xlabel(r'l$_d$ (km)')
    ...
    plt.figure(9)
    plt.plot(l_ds/1e3, -delhs, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.xlabel(r'l$_d$ (km)')
    ...
    plt.figure(10)
    plt.plot(l_ds/1e3, p_LCLs/1e2, 'o-', label=r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    plt.xlabel(r'l$_d$ (km)')
    plt.ylabel(r'$p_{LCL}$ (hPa)')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day'.format(dheatrate))
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'pLCL_varyld_varyQm.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'pLCL_varyld_varyQm.pdf')
