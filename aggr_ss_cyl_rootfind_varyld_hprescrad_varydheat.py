...
domsizes = np.linspace(1000, 8500, 20)
#colors = ['k', 'r', 'g']



dheatrates = np.array([-1, -1.5, -2])
end = len(dheatrates)
...
for v, dheatrate in enumerate(dheatrates):
    ...
    plt.title(r'$Q_{{m,trop}}$ = {:2.1f} K/day'.format(mheatrate))
    if v == end-1:
        plt.legend()
        plt.savefig(fout + 'massbalance_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'massbalance_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend()
        plt.savefig(fout + 'waterbalance_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'waterbalance_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'Ebalance_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'Ebalance_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'lm_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'lm_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'sigma_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'sigma_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'wm_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'wm_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'RHm_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'RHm_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'P_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'P_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'deltah_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'deltah_varyld_varyQd.pdf')
    ...
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'pLCL_varyld_varyQd.pdf')
        plt.close()
    else:
        plt.savefig(fout + 'pLCL_varyld_varyQd.pdf')
