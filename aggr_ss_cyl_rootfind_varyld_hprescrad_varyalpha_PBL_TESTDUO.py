...
fout = '/Users/cpatrizio/Google Drive/figures/simplemodelNEW/'
...
domsizes = np.linspace(5500, 40000, 20)
#colors = ['k', 'r', 'g']
...
for v, alpha_s in enumerate(alphas):
    
    #cplot =  str(v/(1.0*len(alphas)))
    alphplot = 1 - v/(1.0*len(alphas))
    ...
    for j, domsize in enumerate(domsizes):
        ...
        #Q_mtrop = (S - sig*T_c**4)
        mheatrate=float(-0.6)#prescribed heating rate in moist region interior K/day
        ...
        def equations(p):
            ...
            return (l_m - ((omega_BL*l_d**2)/(omega_BL - (g*Q_mtrop)/(dels_LCL + (1+ alpha_s/(1-alpha_s))*L_v*(f*q_sat -  q_FA))))**(0.5), \
        ...
        omega_m = (g*Q_mtrop)/(dels_LCL + (1+ alpha_s/(1-alpha_s))*L_v*(f*q_sat - q_FA))
        ...
        E = (1./g)*(2*np.pi*omega_BL)*(q_sat - q_FA)*((l_d**2 - l_m**2)/2. + zhat*(l_d - l_m) - zhat*(zhat + l_d)*(1 - np.exp((l_m - l_d)/zhat))) + alpha_s*P
        ...
        delhseff[j] = delhs[j] + ((L_v*alpha_s)/(1-alpha_s))*(f*q_sat -  q_FA)
        p_LCLs[j] = p_LCL
    
        
    plt.figure(1)
    plt.plot(l_ds/1e3, massbalance, 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    ...
    if v == end-1:
        #plt.legend()
        plt.savefig(fout + 'massbalance_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate, mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'massbalance_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate, mheatrateHEAT))
    
    plt.figure(2)
    plt.plot(l_ds/1e3, waterbalance, 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'E - P (mm/day)')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend()
        plt.savefig(fout + 'waterbalance_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate, mheatrateHEAT))
       #plt.close()
    else:
        plt.savefig(fout + 'waterbalance_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate, mheatrateHEAT))
    ...
    plt.figure(3)
    plt.plot(l_ds/1e3, Ebalance, 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'condensation warming - radiative cooling (J s$^{-1}$)')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'Ebalance_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate, mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'Ebalance_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
    ...
    plt.figure(4)
    plt.plot(l_ds/1e3, l_ms/1e3, 'b-', alpha=alphplot,  label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$l_c$ (km)')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'lm_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'lm_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
    ...
    plt.figure(5)
    plt.plot(l_ds/1e3, (l_ms**2/l_ds**2), 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$\sigma$')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'sigma_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'sigma_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
    ...
    plt.figure(6)
    plt.plot(l_ds/1e3, w_ms, 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'w$_m$ (m/s)')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'wm_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'wm_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))

    plt.figure(7)
    plt.plot(l_ds/1e3, RHs, 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.ylim(0,1)
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'RH$_m$')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'RHm_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'RHm_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))

    plt.figure(8)
    plt.plot(l_ds/1e3, Ps, 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'P (mm/day)')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'P_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'P_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
    ...
    plt.figure(9)
    plt.plot(l_ds/1e3, delhs, 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$\Delta h_{trop}$ (J)')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'deltah_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'deltah_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        
    plt.figure(10)
    plt.plot(l_ds/1e3, delhseff, 'b-', alpha=alphplot, label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$\Delta h_{trop,eff}$ (J)')
    #plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'deltaheff_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'deltaheff_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
    ...
    plt.figure(11)
    plt.plot(l_ds/1e3, p_LCLs/1e2, 'b-', alpha=alphplot,  label=r'cool, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$p_{LCL}$ (hPa)')
    #plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        #plt.legend(loc='best')
        plt.savefig(fout + 'pLCL_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        #plt.close()
    else:
        plt.savefig(fout + 'pLCL_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        
        
domsizes = np.linspace(200, 8000, 20)
#colors = ['k', 'r', 'g']


alphas = np.array([0.00])
#alphas = np.array([0])
...
for v, alpha in enumerate(alphas):
    ...
    for j, domsize in enumerate(domsizes):
        ...
        #W_m = (S - sig*T_c**4)/(c.cpd*M_trop)
        #Q_mtrop = (S - sig*T_c**4)
        mheatrateHEAT=float(0.6)#prescribed heating rate in moist region interior K/day
        Q_mtrop = (c.cpd*M_trop*mheatrateHEAT)/(86400)
        ...
        l_m, f = fsolve(equations, [100e3, 0.4], maxfev=1000000, xtol=1e-16)
        ...
        RHs[j] = q_BLm/q_BLsat
        delhs[j] = dels_LCL + L_v*(f*q_sat -  q_FA)
        delhseff[j] = delhs[j] + ((L_v*alpha)/(1-alpha))*(f*q_sat -  q_FA)
        p_LCLs[j] = p_LCL
    
        
    plt.figure(1)
    plt.plot(l_ds/1e3, massbalance, 'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'mass down - mass up (Pa m$^{2}$ s$^{-1}$)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
        plt.legend()
        plt.savefig(fout + 'massbalance_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        plt.close()
    ...
    plt.figure(2)
    plt.plot(l_ds/1e3, waterbalance, 'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'E - P (mm/day)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
    ...
    plt.figure(3)
    plt.plot(l_ds/1e3, Ebalance, 'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'condensation warming - radiative cooling (J s$^{-1}$)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
    ...
    plt.figure(4)
    plt.plot(l_ds/1e3, l_ms/1e3, 'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$l_c$ (km)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
    ...
    plt.figure(5)
    plt.plot(l_ds/1e3, (l_ms**2/l_ds**2), 'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$\sigma$')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
    ...
    plt.figure(6)
    plt.plot(l_ds/1e3, w_ms,  'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'w$_m$ (m/s)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
    ...
    plt.figure(7)
    plt.plot(l_ds/1e3, RHs,  'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.ylim(0,1)
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'RH$_m$')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    ...
    plt.figure(8)
    plt.plot(l_ds/1e3, Ps,  'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'P (mm/day)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
    ...
    plt.figure(9)
    plt.plot(l_ds/1e3, delhs, 'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$\Delta h_{trop}$ (J)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
    ...
    plt.figure(10)
    plt.plot(l_ds/1e3, delhseff,  'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$\Delta h_{trop,eff}$ (J)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
    ...
    plt.figure(11)
    plt.plot(l_ds/1e3, p_LCLs/1e2,  'r-', alpha=alphplot, label=r'heat, $\alpha$ = {:2.3f}'.format(alpha_s))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$p_{LCL}$ (hPa)')
    plt.title(r'$Q_{{d,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f}, {:2.3f} K/day'.format(dheatrate, mheatrate,mheatrateHEAT))
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'pLCL_varyalpha_Qm{:2.3}Qm{:2.3}.pdf'.format(mheatrate,mheatrateHEAT))
        plt.close()
