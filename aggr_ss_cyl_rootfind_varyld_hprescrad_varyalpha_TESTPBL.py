...
domsizes = np.linspace(4000, 40000, 20)
#colors = ['k', 'r', 'g']

domsizes = np.linspace(200, 4500, 20)
...
for v, alpha in enumerate(alphas):
    ...
    plt.figure(1)
    plt.plot(l_ds/1e3, massbalance, '.-', color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(2)
    plt.plot(l_ds/1e3, waterbalance, '.-', color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(3)
    plt.plot(l_ds/1e3, Ebalance, '.-',  color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(4)
    plt.plot(l_ds/1e3, l_ms/1e3, '.-', color=cplot,  label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$l_c$ (km)')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
    ...
    plt.figure(5)
    plt.plot(l_ds/1e3, (l_ms**2/l_ds**2), '.-',  color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'$\sigma$')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
    ...
    plt.figure(6)
    plt.plot(l_ds/1e3, w_ms, '.-',  color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(7)
    plt.plot(l_ds/1e3, RHs, '.-',  color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.ylim(0,1)
    plt.xlabel(r'$l_d$ (km)')
    plt.ylabel(r'RH$_c$')
    plt.title(r'$Q_{{d,net,trop}}$ = {:2.1f} K/day, $Q_{{c,net,trop}}$ = {:2.3f} K/day'.format(dheatrate, mheatrate))
    if v == end-1:
        plt.legend(loc='best')
        plt.savefig(fout + 'RHm_varyalpha_Qm{:2.3}.pdf'.format(mheatrate))
        plt.close()
    else:
        plt.savefig(fout + 'RHm_varyalpha_Qm{:2.3}.pdf'.format(mheatrate))

    plt.figure(8)
    plt.plot(l_ds/1e3, Ps, '.-',  color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(9)
    plt.plot(l_ds/1e3, delhs, '.-',  color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
    ...
    plt.figure(10)
    plt.plot(l_ds/1e3, delhseff, '.-',  color=cplot, label=r'$\alpha$ = {:2.3f}'.format(alpha))
    plt.xlabel(r'$l_d$ (km)')
